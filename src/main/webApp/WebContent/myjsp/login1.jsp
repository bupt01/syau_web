...
<style type="text/css">
	@IMPORT url("${pageContext.request.contextPath}/myjsp/login1.css");
</style>
</head>
<body>
	<div id="page">
	<!-- -------------------------top---------------------------- -->
		<div id="top">
			<div id="top_left">
				<img alt="标志" src="${pageContext.request.contextPath}/myjsp/images/snlogin.png">
			</div>
			<div id="top_right">
			...
			<div id="main_body">
				<form action="${pageContext.request.contextPath}/admin/login.action" method="post">
					<div class="login_user">
						<i class="icon_user"></i>
						<input type="text" name="username" placeholder="用户名" class="user"/><span>${error}</span>
					</div>
					<div class="login_user">
						<i class="icon_pass"></i>
